...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: nE0euRfzRirZ/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: OiKVnJAqFVMM/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: t8412bnI3B-X/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__fS4T)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__uhZlJ)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__e55Uk)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__aEPw9)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__bSiKc)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,

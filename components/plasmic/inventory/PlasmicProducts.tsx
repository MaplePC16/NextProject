...
import sty from "./PlasmicProducts.module.css"; // plasmic-import: VutgHmlH-Fd0/css
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    getInventoryData: usePlasmicDataOp(() => {
      return {
        ...
        opId: "830c1352-e638-484f-8f58-37cb6e5fe579",
        userArgs: {},
        cacheKey: `plasmic.$.830c1352-e638-484f-8f58-37cb6e5fe579.$.`,
              ...
              {$ctx => (
                ...
                >
                  ...
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__zLbEz)}
                  >
                    <AntdButton
                      className={classNames(
                        "__wab_instance",
                      ...
                      >
                        {(() => {
                          const child$Props = {
                            ...
                            data: {
                              sourceId: "uYxaKXATM7ShXyg2LcApsh",
                              opId: "26534f99-323e-4a5c-9d64-57daa81d7a98",
                              userArgs: {},
                              cacheKey: `plasmic.$.${(() => {
                                try {
                                  return "getSchema";
                              ...
                              })()}.$.w-y7c9hch6jd.$.26534f99-323e-4a5c-9d64-57daa81d7a98.$.`,
                              invalidatedKeys: null,
                              roleId: null
                            },
                            dataFormItems: (() => {
                              ...
                              $steps["defaultSubmit"] = true
                                ? (() => {
                                    const actionArgs = {
                                      dataOp: {
                                        sourceId: "uYxaKXATM7ShXyg2LcApsh",
                                        opId: "a9bacf77-6b5b-4c32-bcc3-a883e8a128c9",
                                        userArgs: {
                                          variables: [
                        ...
                        $steps["postgresDeleteMany"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "uYxaKXATM7ShXyg2LcApsh",
                                  opId: "7ac51e59-3d3f-4776-a999-13bd1ec26cc3",
                                  userArgs: {
                                    conditions: [rowKey]
                                  },
                                  cacheKey: null,
                    ...
                    >
                      {(() => {
                        const child$Props = {
                          ...
                          data: {
                            sourceId: "uYxaKXATM7ShXyg2LcApsh",
                            opId: "8eb2fa64-4618-4b3d-83fb-af9b67764316",
                            userArgs: {
                            ...
                            })()}.$.AIeAfFG7Kaaz.$.8eb2fa64-4618-4b3d-83fb-af9b67764316.$.`,
                            invalidatedKeys: null,
                            roleId: null
                          },
                          dataFormItems: (() => {
                            ...
                            $steps["defaultSubmit"] = true
                              ? (() => {
                                  const actionArgs = {
                                    dataOp: {
                                      sourceId: "uYxaKXATM7ShXyg2LcApsh",
                                      opId: "f367738a-c778-48aa-95f1-075e60e65b23",
                                      userArgs: {
